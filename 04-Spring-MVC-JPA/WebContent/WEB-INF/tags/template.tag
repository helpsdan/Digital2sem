...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <form action="<c:url value="/bebida/buscar"/>" method="get" class="form-inline my-2 my-lg-0">
      <input name="nomeBebida" class="form-control mr-sm-2" type="search" placeholder="Busca de bebida" aria-label="Search">
